...
# 데이터 로드
df_train = pd.read_parquet("/Users/jangseongyu/Documents/GitHub/DoF_Experiment/data/train-00000-of-00001.parquet")
#df_valid = pd.read_parquet(r"C:\Users\dsng3\Documents\GitHub\DoF_Experiment\data\validation-00000-of-00001.parquet")
df_test = pd.read_parquet("/Users/jangseongyu/Documents/GitHub/DoF_Experiment/data/test-00000-of-00001.parquet")
